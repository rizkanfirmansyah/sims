        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="<?= base_url('assets/dist/'); ?>img/stisla-fill.svg" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
              ...
              <div class="card-body">
                <form method="POST" action="<?= base_url('auth/login'); ?>" class="needs-validation" novalidate="">
                  <div class="form-group">
                    ...
                    <input id="username" type="text" class="form-control" name="username" tabindex="1" required autofocus value="<?= set_value('username'); ?>">
